...
class PageFragment(
    ...
    private val bottomTextId: Int) : Fragment() {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        //Inflate Layout based on Page Type
        val view: View = if (pageType == PageAdapter.pageTypeEven) inflater.inflate(R.layout.fragment_page, container, false) else inflater.inflate(R.layout.fragment_page_alt, container, false)
        //Set Top Text
